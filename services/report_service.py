...
def validar_datos_para_guardado(*, total_horas, horas_turno, operador, modelo_equipo, numero_equipo, turno):
    if not report_validation.horas_turno_validas(total_horas, horas_turno):
        ...
        return {"ok": False, "tipo": "horas_invalidas", "mensaje": mensaje}
    ...
    if not report_validation.operador_valido(operador):
        ...
        return {"ok": False, "tipo": "operador_vacio", "mensaje": mensaje}
...
def construir_datos_registro(datos_formulario):
    ...
    return {
        ...
        "Causa detención": produccion["causa_detencion"],
